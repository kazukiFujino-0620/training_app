...
public class MfaService {
  ...
  public boolean isEnabled(Long userId) {
    return mfaSettingDao.selectByUserId(userId).map(UserMfaSetting::getIsEnabled).orElse(false);
  }
  ...
  public MfaSetupDto generateSetup(Long userId, String email) throws QrGenerationException {
    ...
    String qrDataUri =
        "data:" + mimeType + ";base64," + Base64.getEncoder().encodeToString(imageData);
