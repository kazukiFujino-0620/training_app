...
/**
 * Spring Security の認証イベントを購読し、ログイン試行を {@link LoginAttemptService} と {@link IpBlockService} へ連携する。
 */
@Component
@Slf4j
public class AuthenticationEventListener {
  ...
  public AuthenticationEventListener(
      LoginAttemptService loginAttemptService, IpBlockService ipBlockService) {
  ...
  public void onSuccess(AuthenticationSuccessEvent event) {
    ...
    log.info(
        "Authentication success: userHash={}",
  ...
  public void onFailure(AbstractAuthenticationFailureEvent event) {
    ...
    log.warn(
        "Authentication failure: userHash={}, cause={}",
        Integer.toHexString(username == null ? 0 : username.hashCode()),
